...
class ZeroSuppress35tService : public AdcSuppressService {
...
public:
  ...
  ZeroSuppress35tService(AdcCount ts, AdcCount tl, AdcCount td, Index ns, Index nl, Index nd, Index nt);
...
DECLARE_ART_SERVICE_INTERFACE_IMPL(ZeroSuppress35tService, AdcSuppressService, LEGACY)
