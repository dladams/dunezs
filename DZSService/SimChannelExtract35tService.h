...
class SimChannelExtract35tService : public SimChannelExtractServiceBase {
...
DECLARE_ART_SERVICE_INTERFACE_IMPL(SimChannelExtract35tService, SimChannelExtractServiceBase, LEGACY)
