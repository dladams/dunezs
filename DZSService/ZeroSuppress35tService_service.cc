...
typedef ZeroSuppress35tService::Index Index;
...
ZeroSuppress35tService(AdcCount ts, AdcCount tl, AdcCount td,
...
void ZeroSuppress35tService::setDebug(int dbg) {
  m_dbg = dbg;
}

//**********************************************************************

DEFINE_ART_SERVICE_INTERFACE_IMPL(ZeroSuppress35tService, AdcSuppressService)
